...
<div align="center"><img src="https://user-images.githubusercontent.com/47635037/91112817-ad0d7c80-e6b6-11ea-9fe8-57cbcf00dc1f.png" alt="newlook-command-admin" style="display:block;margin-left:auto;margin-right:auto;"></div>
...
| `X_ADDITIONAL_ DESCRIPTION_NOTE`  |  `string`  |  `""`   | Refer example below.                                                                                                                                                                                                                                                                                                             |
...
|               `DISABLE_REVIEW_ OFFER_NOTE`               | `boolean`  | `false` | By default, it will show notes on each [reason](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L428-L1564)                                                                                                                                                                                                                                                                                                                |
...
| `DISABLE_AUTO_ DECLINE_OVERSTOCKED_ WITH_INVALID_VALUE`  | `boolean`  | `true`  | Set this to `false` if you want your bot to decline an offer that has both `INVALID_VALUE` and `OVERSTOCKED` reason.                                                                                                                                                                                                                                                                                                                                    |
| `DISABLE_AUTO_ DECLINE_UNDERSTOCKED_ WITH_INVALID_VALUE` | `boolean`  | `true`  | Set this to `false` if you want your bot to decline an offer that has both `INVALID_VALUE` and `UNDERSTOCKED` reason.                                                                                                                                                                                                                                                                                                                                   |
...
|     `CUSTOM_DECLINED_ MESSAGE`      | `string` |  `""`   | Your custom `DECLINED` note. Two parameters can be used - [`%reason%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1194-L1226) and [`%invalid_value_summary%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1228-L1240). |
