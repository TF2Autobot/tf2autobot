...
|      `DISABLE_REVIEW_ OFFER_NOTE`       | `boolean`  | `false` | By default, it will show notes on each [reason](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L423-L1609)                                                                                                                                                                                                                                                                                                                |
...
|     `CUSTOM_DECLINED_ MESSAGE`      | `string` |  `""`   | Your custom `DECLINED` note. Two parameters can be used - [`%reason%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1194-L1220) and [`%invalid_value_summary%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1225-L1237).                                                                                                                 |
