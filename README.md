...
A free and open source fully automated TF2 trading bot both advertising on [backpack.tf](https://backpack.tf) and trading on [steam](https://steamcommunity.com/)  using prices from [prices.tf](https://prices.tf).
...
-   You need a separate [Unlimited](https://support.steampowered.com/kb_article.php?ref=3330-IAGK-7663) Steam account set up with a mobile authenticator. (I suggest using the [Steam Desktop Authenticator](https://github.com/Jessecar96/SteamDesktopAuthenticator) to authenticate the account and get the secret keys used to automate the generation of 2FA codes and managment of mobile confirmations).
-   NodeJS with a version 16.x or latest LTS
-   Typescript v4.1 or above
...
## Join the TFAutobot Discord server!
...
### Also, TF2Autobot is now officially supported by JetBrains! Click [Here](https://www.jetbrains.com/?from=TF2Autobot) to know more about it and begin using it.
