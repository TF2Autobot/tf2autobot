...
Click [`options.json`](https://github.com/TF2Autobot/tf2autobot/wiki/library#optionjson-content) to view the content.
...
### - Allow trade with banned account ⛔✅
...
| `.showItemPrices` | `boolean` | `false`  | Set to `true` if you want to include item prices (buying/selling prices). |
...
### - Send Alert Configuration [^](#🔊-send-alert-to-owner)
Property: `.sendAlert`
...
### - Send Statistic Configuration [^](#--automatic-sending-stats-📊⌚)
Property: `.sendAlert`
